...
st.sidebar.text("A Twitter sentiment analysis webappTwitter Sentment Analysis Web App using #Hashtag")
st.sidebar.text("and username to fetch tweets and tells the sentiment of the perticular #Hashtag or username.")
