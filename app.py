...
st.sidebar.text("A Twitter sentiment analysis ")
st.sidebar.text("webappTwitter Sentment Analysis") 
st.sidebar.text("Web App using #Hashtag")
st.sidebar.text("and username to fetch tweets ")
st.sidebar.text("and tells the sentiment ")
st.sidebar.text("of the perticular #Hashtag") 
st.sidebar.text("or username.")
st.sidebar.title("Made by students of GTBIT: ")
